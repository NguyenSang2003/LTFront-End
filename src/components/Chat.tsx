                    ...
                    const handleMessage = (msg: MessageEvent) => {
                            ...
                            // Khi tạo phòng
                                ...
                                if (data.data && data.data.id) {
                                    ...
                                    console.error("Room name already exists or cannot create room");
                                    alert("Tên phòng đã tồn tại hoặc không thể tạo phòng.");
                                }
                            }
                            // Khi tạo phòng
                                ...
                                if (data.data && data.data.id) {
                                    ...
                                    console.error("Room does not exist or cannot join the room");
                                    alert("Phòng không tồn tại hoặc không thể tham gia vào phòng.");
                                }
                            }
                        ...
                        <div
                            ...
                            <div className="dropdown">
                                <button
                                    ...
                                    type="button"
                                    onClick={() => toggleDropdown2(1)}>
                                    Tuỳ chọn
                                </button>

                                <div className={`dropdown-menu ${dropdownVisible === 1 ? 'show' : ''}`}>
                                    {/* Nút xóa toàn bộ tin nhắn */}
                                    <button className="dropdown-item text-danger" onClick={deleteMessages}
                                            title={"Xóa toàn bộ"}>
                                        <i className="fa-solid fa-trash"></i>
                                    </button>
